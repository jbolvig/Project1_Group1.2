...
void writeDataB()  {
  ...
  // Print headers
  Serial.println(F("Date,Time,Humidity,Pressure,Temperature"));
  // Print date
  ...
  File dataFile = SD.open("dataB.csv", FILE_WRITE); // open file and write to it
  ...
  // If file is not found print error message
    ...
    Serial.println(F("Error opening dataB.csv"));
  }
