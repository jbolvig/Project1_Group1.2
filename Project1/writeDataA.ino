...
void writeDataA()  {
  ...
  // Print headers
  Serial.println(F("Pressure,Temperature,Altitude"));
  // Print to serial monitor
  Serial.print(pres, 2);
  Serial.print(",");
  Serial.print(temp, 2);
  ...
  File dataFile = SD.open("dataA.csv", FILE_WRITE); // open file and write to it
  ...
  // If file is not found print error message
    ...
    Serial.println(F("Error opening dataA.csv"));
  }
